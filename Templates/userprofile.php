                  ...
                  if ($Userpic == ''){
                    ...
                    echo "<h4>".$Userdetails['firstname']."</h4>";
                     ...
                     ?>
                      ...
                      echo "<a href='profilepic.php' class='btn btn-outline-primary'>Change Profile Pic</a>";
                      ?>
                    </div>
                  </div>
                </div>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
                    ...
                    echo  '<span class="float-right"><a href="userdetails.php"><i class="fas fa-edit"></i></a></span>';
                    echo '</div>
                  </div>
                  <hr>
                  <div class="row">
              ...
              <div class="row gutters-sm">
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                    <span class="float-right"><a href="useraddress.php"><i class="fas fa-edit"></i></a></span>
                ...
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                    <span class="float-right"><a href="usereducation.php"><i class="fas fa-edit"></i></a></span>
