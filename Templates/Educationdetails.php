...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-2">
    ...
    <form class="personaldetails my-5" action="" method="POST">
        ...
        <div class="input-group form-group">
            ...
            <input type="text" class="form-control" id="schoolname" aria-describedby="schoolname" name="schoolname" placeholder="School Name" required>
        </div>
        ...
        <div class="input-group form-group" id="otherFieldGroupDivcten">
            ...
            <input type="text" class="form-control" id="tenthmark" aria-describedby="tenthmark" name="tenthmarkc" placeholder="CGPA" required>
        </div>
        ...
        <div class="input-group form-group" id="otherFieldGroupDivpten">
            ...
            <input type="text" class="form-control" id="tenthmark" aria-describedby="tenthmark" name="tenthmarkp" placeholder="Perc(%)" required>
        </div>
        ...
        <div class="input-group form-group" >
            ...
            <input type="text" class="form-control" id="clgname" aria-describedby="clgname" name="clgname" placeholder="College Name" required>
        </div>
        ...
        <div class="input-group form-group" id="twmarkcgpa">
            ...
            <input type="text" class="form-control" id="twmark" aria-describedby="twmark" name="twmarkc" placeholder="CGPA" required>
        </div>
        ...
        <div class="input-group form-group" id="twmarkperc">
            ...
            <input type="text" class="form-control" id="twmark" aria-describedby="twmark" name="twmarkp" placeholder="Perc" required>
        </div>
        ...
        <div class="input-group form-group">
            ...
            <input type="text" class="form-control" id="uniname" aria-describedby="uniname" name="uniname" placeholder="University Name" required>
        </div>
        ...
        <div class="input-group form-group">
            ...
            <input type="text" class="form-control" id="unimark" aria-describedby="unimark" name="unimark" placeholder="University CGPA" required>
        </div>
